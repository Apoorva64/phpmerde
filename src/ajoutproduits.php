	...
	<td>
		...
		<form method="post">
			<table border="2">
				...
				<tr> <td>Code</td> <td><input type='text' name="idrecettes" value=""></td></tr>
				<tr> <td>nom</td> <td><input type="text" name="nom" value=""></td></tr>
        <tr> <td>preparation</td> <td><input type="text" name="preparation" value=""></td></tr>
        <tr> <td>cout</td> <td><input type="text" name="cout" value=""></td></tr>
				<tr><td>Photo </td><td><input type="file" name="uploaded_file"></input></td></tr>

        <tr> <td>No client </td> <td><input type="text" name="idmembre" value=""></td></tr>
        <nobr><br><br>
